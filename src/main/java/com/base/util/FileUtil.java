...
public class FileUtil {
    ...
    /* 压缩包 */
    private static String[] zip = {"rar", "zip"};
     ...
     * @return
     */
    public static boolean ifDoc(String fileExt) {
        List<String> list = Arrays.asList(doc);
        return list.contains(fileExt);
    }
     ...
     * @return
     */
    public static boolean ifMp3(String fileExt) {
        List<String> list = Arrays.asList(mp3);
        return list.contains(fileExt);
    }
     ...
     * @return
     */
    public static boolean ifAvi(String fileExt) {
        List<String> list = Arrays.asList(avi);
        return list.contains(fileExt);
    }
     ...
     * @return
     */
    public static boolean ifZip(String fileExt) {
        List<String> list = Arrays.asList(zip);
        return list.contains(fileExt);
    }
