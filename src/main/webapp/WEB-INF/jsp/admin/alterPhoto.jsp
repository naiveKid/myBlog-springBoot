                    ...
                    <table class="layui-table">
                        ...
                        <tr>
                            ...
                            <td height="30" style="font-size: 18px;">
                                <input type="text" style="width:90%;height:24px;" name="pictureTitle" class="layui-input" id="pictureTitle" value="${picture.pictureTitle}">
                            </td>
                        </tr>
                        <tr>
                            <td height="30" style="font-size: 18px;">相片描述</td>
                            <td height="30" style="font-size: 18px;"><input type="text" style="width:90%;height:24px;" name="pictureContent" class="layui-input" id="pictureContent" value="${picture.pictureContent}"></td>
                        </tr>
                    </table>
                    <br/> <br/> <br/>
                    <center>
